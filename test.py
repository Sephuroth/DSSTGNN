...
import argparse
import torch
from models.DSSTGNN import DSSTGNN
import numpy as np
...
parser.add_argument('--checkpoint', type=str, default='log/2025-04-08-20:45:52-METEO/best_model.pth', help='')
...
def main():
    ...
    model = DSSTGNN(device, args.input_dim, args.channels, args.num_nodes, args.input_len, args.output_len, args.dropout)
    model.to(device)
